...
export const ENV = {
  ...
  PROVIDER_HEALTH_SAMPLE_INTERVAL_MS: positiveIntegerMsEnv('PROVIDER_HEALTH_SAMPLE_INTERVAL_MS', 300_000),
  PROVIDER_HEALTH_SAMPLE_RECENT_MS: positiveIntegerMsEnv('PROVIDER_HEALTH_SAMPLE_RECENT_MS', 900_000),
